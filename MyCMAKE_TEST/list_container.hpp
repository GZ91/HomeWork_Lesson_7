...
public:
	...
	explicit List_container(List_container& rv) :size_container{ rv.size_container }, begin_node{ rv.begin_node }, end_node{ rv.end_node }, current_node{ rv.current_node }{}
	List_container(List_container && rv);
	void push_back(T);
	void insert(T, int);
	void erase(int);
	int size();
